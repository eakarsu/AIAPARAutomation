...
// v0 scaffold for: No AI GL-coding suggestion from invoice line items
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-gl-coding-suggestion-invoice/run.

export default function AiGlCodingSuggestionInvoicePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-gl-coding-suggestion-invoice/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI GL-coding suggestion from invoice line items</h1>
