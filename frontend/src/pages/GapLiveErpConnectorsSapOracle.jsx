...
// v0 scaffold for: No live ERP connectors (SAP, Oracle, NetSuite, QuickBooks)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-live-erp-connectors-sap-oracle/run.

export default function LiveErpConnectorsSapOraclePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-live-erp-connectors-sap-oracle/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No live ERP connectors (SAP, Oracle, NetSuite, QuickBooks)</h1>
